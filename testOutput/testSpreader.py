...
def on_message(client, userdata,message):
    ...
    try:  
      if payload_data:  
       if movement == "none": # Only accepts movement that is "none" which is the enter button
        if speed == "normal" : # normal speed
         # For spreader lock and unlock
         if movement == "none" and lock == False: 
              print("Crane lock is unlocked" )  
         else:
              print("Crane lock is locked")      
